/**
 * V3: SVG 工具函数
 * 从 FUXA 复制，移除 Angular 依赖（@Injectable 装饰器）
 */
...
export class SvgUtils {
    ...
    static getSvgSize(svgElement: SVGSVGElement): { width: number, height: number } | undefined {
    ...
    static toWidgetPropertyVariable(originalVar: string, varName: string): WidgetPropertyVariable | null {
