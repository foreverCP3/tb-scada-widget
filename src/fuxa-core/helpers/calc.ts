...
export class Calc {
    ...
    static integral(timeserie: TimeValue[], collectionType: CollectionType, unit?: number): { [key: number]: number } {
        ...
        let addToCollection = (collections: { [key: number]: number }, collectionIndex: number, value: number) => {
        ...
        let getCollectionTime = (millyDt: number, collectionType: CollectionType, next: boolean) => {
        ...
        let lastRecord: TimeValue | null = null;
        let lastCollectionIndex: number | null = null;
        for (let i = 0; i < sorted.length; i++) {
            ...
            while (lastCollectionIndex && lastRecord && lastCollectionIndex < collectionIndex) {
